...
namespace WebApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
       ...
       [Authorize(Roles = "admin")]
        ...
        public async Task<IActionResult> Charge(Guid userId, string stripeToken, PaymentChargeDto paymentChargeDto)

        {
            ...
            {
                Amount = paymentChargeDto.price * 100 / 16,
            ...
            var payment = new Payment
            {
                ...
                IsPaid = charge.Paid,
                OrderId = paymentChargeDto.OrderId
            };
